...
## 🔧 改进
- 移除 README 中的个人公网 IP 地址
- 使用占位符 `your.public.ip` 替代
...
## 📝 文档更新
- 更新了 `FREQUENCY_DATASET` 的注释说明
- 明确数据集存储的是波形频率(ms)而非脉冲频率(Hz)
...
## 🔧 改进
- 移除 dotenv 依赖，直接读取环境变量
- 添加 DG-LAB 开源协议声明到 README
